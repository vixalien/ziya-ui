      ...
      <Modal visible={showMenu}>
        <div className="menu" {...props}>
          <div className="close-bar" onClick={hideMenu}>
            <Close size={24} />
            <span>Close</span>
            <Loader size={24} className="spinner" style={{display: spinner}}/>
          </div>
          <div className="search-bar">
            <Search showCancel={true} onChange={search} onSubmit={() => console.log('Submit')} onCancel={() => console.log('Cancel')} onClear={() => console.log('Clear')}/>
          </div>
          <div className="links">
